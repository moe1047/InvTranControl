        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" ng-controller="sale" ng-cloak>
                        <div class="alert alert-success alert-dismissible" ng-show="success">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <strong>Success!</strong> Sales has been updated successfully.
                        </div>
...
@section('scripts')
    <script>
        ...
        myApp.controller('sale',function($scope,$http,$timeout){
            $scope.sale_id=document.getElementById('sale_id').value;
            console.log($scope.sale_id);

            $http.get('/sale/'+$scope.sale_id).then(function(result){
                console.log()
            });
